...
SELECT app_name, COUNT(*) FROM analytics GROUP BY app_name,reviews ORDER BY COUNT(*) desc LIMIT 5; 

-- 5.Find the app that has the most reviews with a rating greater than equal to 4.8.
SELECT reviews,rating,app_name
 FROM analytics
 WHERE rating > 4.9
  GROUP BY reviews,rating,app_name
   ORDER BY COUNT(*) desc
    LIMIT 1;
